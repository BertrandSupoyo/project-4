...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Format month and year for filtering
    ...
    // Get substations with measurements filtered by month-year
    ...
    console.log(`✅ Found ${substations.length} substations with measurements for ${monthYear}`);
    ...
    const filename = `Riwayat_Pengukuran_${monthName}_${yearStr}.xlsx`;
